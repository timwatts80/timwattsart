    ...
    <section id="gallery-preview" className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-sm uppercase font-light mb-4">Featured Artwork</h2>
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            A curated selection of my latest works. Each piece represents a unique exploration of form, color, and emotion.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {loading ? (
            ...
            artworks.filter(piece => piece.featured).map((piece) => (
